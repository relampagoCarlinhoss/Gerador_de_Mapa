...
TEST_CASE("Testa a criação de uma paleta padrão (sem nenhuma cor)") {
    Paleta paleta;
    CHECK(paleta.consultarTamanho() == 0);
}
...
TEST_CASE("Testa a adição de cores uma paleta vazia") {
    ...
    CHECK(paleta.consultarTamanho() == 1);
    CHECK(paleta.consultarCor(0).r == 255);
    CHECK(paleta.consultarCor(0).g == 0);
    CHECK(paleta.consultarCor(0).b == 0);
}
...
TEST_CASE("Testa a obtenção de uma cor com índice inválido") {
    ...
    Cor corInvalida = paleta.consultarCor(5); // índice inválido (maior que o tamanho)
...
TEST_CASE("Testa a criação de uma paleta a partir de um arquivo válido") {
    ...
    CHECK(paleta.consultarTamanho() == 30);
    CHECK(paleta.consultarCor(0).r == 113);
    CHECK(paleta.consultarCor(0).g == 171);
    CHECK(paleta.consultarCor(0).b == 216);

    CHECK(paleta.consultarCor(1).r == 121);
    CHECK(paleta.consultarCor(1).g == 178);
    CHECK(paleta.consultarCor(1).b == 222);
    
    //... outras cores

    CHECK(paleta.consultarCor(29).r == 255);
    CHECK(paleta.consultarCor(29).g == 255);
    CHECK(paleta.consultarCor(29).b == 255);
}
